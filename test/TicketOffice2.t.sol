...
//       uint256 eventDate, string concertLocation,string venueName ,string[] performers, string[] keywords, string[] categories, string eventType);
...
//         ticketOffice = new TicketOffice(name,0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48, address(0x70AFEF91DAe765B1E45A9736c21D7cd061EAf205));
...
//         ticketSoldArray[1] = 0;
//         ticketSoldArray[2] = 0;
//         location = TicketStructs.LocationDetails({
...
//         vm.expectEmit();
//         emit Event(0,eventName, address(0x104fBc016F4bb334D775a19E8A6510109AC63E00),baseUrl,ticketNames,ticketPrices,ticketCapacities,eventDate,concertLocation,venueName,groups,keywords,categories,eventType);
...
//         // Expect Afer Ticket Transfer Works.
//         vm.stopPrank();
//         vm.startPrank(contractOwner);
//         ticketOffice.unLockEvent(0);
