...
//         vm.startPrank(ownerWallet);
//         ticketOffice.createEvent(name, baseUrl, ticketNames, ticketPrices, ticketCapacities, eventDate, location, groups, keywords,categories);
...
//         emit Event(0,name, address(0x104fBc016F4bb334D775a19E8A6510109AC63E00),ticketNames,ticketPrices,ticketCapacities,eventDate,location,newGroups,keywords,categories);
...
//         vm.expectEmit();
//         emit Event(0,name, address(0x104fBc016F4bb334D775a19E8A6510109AC63E00),ticketNames,ticketPrices,ticketCapacities,eventDate,"Antartica",groups,keywords,categories);
...
//         vm.expectEmit();
//         emit Event(0,name, address(0x104fBc016F4bb334D775a19E8A6510109AC63E00),ticketNames,ticketPrices,ticketCapacities,eventDate + oneDay * 3,location,groups,keywords,categories);
...
//         vm.expectEmit();
//         emit Event(0,name, address(0x104fBc016F4bb334D775a19E8A6510109AC63E00),ticketNames,ticketPrices,ticketCapacities,eventDate + oneDay * 4,location,groups,keywords,categories);
